<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"> Hadits</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">Bab <?=$this->session->userdata('id_master_bab')?> :</label>
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">Kitab <?=$this->session->userdata('id_master_kitab')?> :</label>
                                ...
                                <?php foreach($viewMHadits as $a): ?>
                                    <div class="card" style="width: 80%;">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-justify"><?=substr($a->hadits_content, 0, 100)?>...<a href="<?=base_url('Hadits/Detail/'.$a->id_master_hadits)?>">Selengkapnya</a></p>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                                </div>
